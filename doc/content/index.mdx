...
description: Real-time EEG streaming platform for PiEEG shields — 250 Hz WebSocket streaming, live dashboard, and brain-computer interface tools.
---
...
**Real-time EEG streaming platform for PiEEG shields (8/16 ch)**
