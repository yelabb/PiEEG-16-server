...
<Callout type="info">
  IronBCI-32 requires the serial extra: `pip install pieeg-server[ironbci32]`. Pure-Python pyserial driver — no BrainFlow required. 32 channels at 250 Hz over USB CDC, FreeEEG wire protocol at 921600 baud.
</Callout>
